...
class ViewControllerTests_NewPassword_Validation: XCTestCase {
    ...
    func testEmptyPassword() throws {
        ...
        let isValidNewPassword = vc.newPasswordTextField.validate()
        //        let isValidConfirmPassword = vc.confirmPasswordTextField.validate()
        XCTAssertFalse(isValidNewPassword)
    ...
    func testValidPassword() throws {
        ...
        vc.resetPasswordButtonTapped(sender: UIButton())
        let isValidNewPassword = vc.newPasswordTextField.validate()
        XCTAssertTrue(isValidNewPassword)
...
class ViewControllerTests_Confirm_Password_Validation: XCTestCase {
    ...
    func testEmptyPassword() throws {
        ...
        vc.resetPasswordButtonTapped(sender: UIButton())
        let isValidConfirmPassword = vc.confirmPasswordTextField.validate()
        XCTAssertFalse(isValidConfirmPassword)
    ...
    func testPasswordsMatch() throws {
        ...
        vc.resetPasswordButtonTapped(sender: UIButton())
        let isValidConfirmPassword = vc.confirmPasswordTextField.validate()
        XCTAssertTrue(isValidConfirmPassword)
